# Generated by Django 3.0.3 on 2020-05-07 11:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', openfacstrack.apps.core.models.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', openfacstrack.apps.core.models.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('data_type', models.CharField(choices=[('Numeric', 'Numeric'), ('Text', 'Text'), ('Date', 'Date'), ('Derived', 'Derived'), ('Other', 'Other')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', openfacstrack.apps.core.models.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', openfacstrack.apps.core.models.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('entry_type', models.CharField(choices=[('INFO', 'INFO'), ('ERROR', 'ERROR'), ('WARN', 'WARN')], default='INFO', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='track.Panel')),
                ('processed_sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='track.ProcessedSample')),
                ('uploaded_file', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='track.UploadedFile')),
            ],
            options={
